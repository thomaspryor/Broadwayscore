...
**Discovery surfaces (2026-07-13):** homepage shelf 'Pre-Broadway: Out-of-Town Shows' (below Best of the West End) + /browse/pre-broadway-out-of-town-shows (sections: On Stage Now / Transferred to Broadway / Recent Tryouts; hideRanks). Both featureFlags.regional-gated (flag-off: shelf absent, page 404, out of sitemap/static-params via getAllBrowseSlugs). Regional poster treatment: portraitCardFromKeyArt in fetch-show-images-auto.js — landscape title-art letterboxed over blurred self, never attention-cropped (amputates titles).
