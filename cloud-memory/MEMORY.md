...
- [Supabase free-tier auto-pause](feedback_supabase_freetier_pause.md) — INACTIVE after 7d idle → NXDOMAIN, all sign-in/read/write dead; check Management API status, run Restore workflow; daily round-trip = keep-alive
