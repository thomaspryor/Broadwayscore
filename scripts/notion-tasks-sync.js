...
// Reuse task-reclaim.js's constants rather than re-declaring a 3rd copy —
...
const { TERMINAL_CARD_STATUSES, DEFAULT_IDLE_MS: LIVENESS_IDLE_MS } = require('./lib/task-reclaim.js');
...
module.exports = { MIRROR_FMT, parseArgs, mapStatus, mergeStatus, mapCardToTask, isMirrorableCard, planPull, planSelfHeal, planStatusDrift, planLivenessDowngrade, NEVER_OVERWRITE_WITH_DONE, nextId, allocateFreeId, taskBelongsTo, notionMarker, writeTask, readTask, readLiveTask, readHwm, writeHwm, acquireLock, readMap, mapPath };
