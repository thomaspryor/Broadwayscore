...
Usage:
  node scripts/remove-placeholder-images.js [options]
  node scripts/remove-placeholder-images.js --help, -h    print this usage and exit
`;
...
const showDirs = listShowDirs(SHOWS_DIR);
