...
const stubs = {
  ...
  // Additional files statically imported by src/ — must exist or `next build` fails.
  'data/actor-slugs.json': { entries: {} },
  'data/cast-manifest.json': { entries: [] },
  'data/slug-redirects-compact.json': {},
  'data/tony-prediction-retrospectives.json': {},
  'data/video-creators.json': { creators: [] },
  'data/video-reviews.json': { _meta: { lastUpdated: NOW } },
};
