...
const showBySlug = {
  ...
  'mamma-mia-2001': { id: 'mamma-mia-2001-id', slug: 'mamma-mia-2001' },
...
test('never matches a legit distinct-production slug that looks like an ID (mamma-mia-2001)', () => {
  // mamma-mia-2001 IS a slug in shows.json — clause 1 must exclude it even
  // though mamma-mia is also present. A "-YYYY suffix" heuristic would fail here.
  const pairs = findDuplicateKeyPairs(
