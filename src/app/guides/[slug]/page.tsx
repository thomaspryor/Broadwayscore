...
import { getMarketLabel, isLondonMarket } from '@/lib/venue-classification';
                    ...
                    <div className="mt-3 flex flex-wrap gap-2">
                      ...
                      {ticketLinks.slice(1, 4).map((link, i) => (
                        <TicketLink
                          ...
                          linkPosition={i + 1}
                          totalLinks={ticketLinks.length}
                          className="hidden sm:inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-surface-overlay hover:bg-white/10 text-gray-300 hover:text-white text-xs font-medium transition-colors border border-white/10"
                        >
                      ...
                      {/* Lottery/Rush — subdued, end of row */}
                      {lotteryRush && (
                        <Link
                          href={`/show/${show.slug}#discount-tickets`}
                          className="hidden sm:inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-surface-overlay hover:bg-white/10 text-gray-500 hover:text-gray-300 text-xs font-medium transition-colors border border-white/5"
                        >
                          <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z" />
                          </svg>
