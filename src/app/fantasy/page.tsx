      ...
      <section className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="space-y-4">
          {[
            ...
            {
              q: 'Why are some shows marked with ★?',
              a: 'These shows opened before the scoring window, so their CriticScore is already locked in. They won\'t earn critic points, but they still earn box office and awards points.',
            },
            {
              q: 'What about Off-Broadway shows?',
              a: 'Priced $1-$3. They can earn CriticScore and AudienceGrade points, but no box office (they don\'t report grosses) and no Tony nominations.',
            },
          ].map(({ q, a }) => (
