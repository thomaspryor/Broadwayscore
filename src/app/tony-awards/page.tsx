...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Critic consensus scores are among the strongest predictors of Tony outcomes. In recent seasons, the Best Musical winner has consistently been in the top 3 of eligible shows by aggregated critic score.',
      },
    },
    {
      '@type': 'Question',
