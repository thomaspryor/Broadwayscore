/**
 * Unit tests for the rolling-EMA Gemini calibration script (Phase B, task #384).
 */
...
const { computeSignedGap, computeEma, recommendedOffsetFromEma } = require('../../scripts/llm-scoring/gemini-calibration-ema');
