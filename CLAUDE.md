...
- **A `--send-to` test send MUST be marked as a test in the email itself** (subject + visible banner via `scripts/lib/test-send-marker.js`), not just full-fidelity real copy (BRO-3577)
